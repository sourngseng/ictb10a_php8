...
<body>
    ...
    ?>  
    <?php
        // កូដខាងក្រោមនេះគីដើម្បីចាប់តម្លៃពី input control តាមឈ្មោះរបស់វា
    ...
    ?>
        ...
        <h3>
            <?php
            //បង្ហាញឈ្មោះពេញចេញពីអថេរដែលបានប្រកាស​​ $fname និង $lName
            // echo "ឈ្មោះរបស់អ្នកគី​ : ". $fName . " " . $lName;
